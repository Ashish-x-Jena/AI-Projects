  ...
  return (
    <main className="analyzer-shell">
      <header className="site-header">
        <div className="brand"><span className="brand-mark"><Sparkles size={18} /></span><span>CareerLens</span></div>
        <span className="header-status"><span className="status-dot" /> AI resume analysis</span>
      </header>
      ...
      <footer><span>CareerLens</span><span>Private by design · Your resume is processed only for this analysis</span></footer>
    </main>
  );
}
